...
//            });
            ...
            this.Pipeline.Event.subscribe('connection:stroke:calculate', function () {
                
            });

            this.Pipeline.Event.subscribe('remove:wire', function () {

            });

            this.Pipeline.Event.subscribe('temp:connection:state', function () {
