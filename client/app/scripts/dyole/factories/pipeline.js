    ...
    function(Event, Node, Connection, $rootScope, systemNodeModel) {
      ...
      Pipeline.prototype = {
        ...
        _attachEvents: function() {
          ...
          this.Event.subscribe('connection:create', function(endTerminal,
            startTerminal) {
        ...
        addNode: function(nodeModel, clientX, clientY, rawCoords) {
          ...
          var appName = nodeModel.name || nodeModel.json.softwareDescription
            .name;

          if (!this.model.schemas[appName]) {
            this.model.schemas[appName] = nodeModel;
          }
