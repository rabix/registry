...
angular.module('registryApp.cliche')
    .controller('InputFieldCtrl', ['$scope', '$modal', '$templateCache', 'Cliche', 'Const', 'ClicheEvents', '$rootScope', function ($scope, $modal, $templateCache, Cliche, Const, ClicheEvents, $rootScope) {
